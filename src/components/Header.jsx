      ...
      <div className="mt-5 p-6 bg-primary gap-5 flex font-semibold text-xl w-[1600px] h-[550px] rounded-sm">
        ...
        >
          <Image
            ...
            width={600}
          />
          <div className="absolute leading-9 box-border m-0 flex flex-col items-start justify-center text-primary text-5xl top-0 left-0 z-20 w-full h-full bg-secondary/80 uppercase">
            {" "}
            <h1>A Home~made </h1>
            <h1>Facebook</h1>
            <h1>for my</h1>
          ...
          <div className="techBadges absolute bottom-1 z-40 text-primary text-xs">
        ...
        >
          ...
          <div className="absolute leading-9 box-border m-0 flex flex-col items-start justify-center text-primary text-5xl top-0 left-0 z-20 w-full h-full bg-secondary/80 uppercase">
            ...
            <h1>Movies</h1>
            <h1>go together</h1>
            <span className="absolute top-[315px] left-[340px] rotate-180">
              ?
            </span>
          </div>
          <div className="techBadges absolute bottom-1 z-40 text-primary text-xs">
        ...
        <div className="relative w-1/3 transition-all duration-500 hover:w-2/3">
          ...
          <div className="absolute leading-9 box-border m-0 flex flex-col items-start justify-center text-primary text-5xl top-0 left-0 z-20 w-full h-full bg-secondary/80 uppercase">
            ...
            <h1p>admin</h1p>
            <h1> dashboard</h1>
            <span className="absolute top-[290px] left-[310px] rotate-45">
              !
            </span>
          </div>
          <div className="techBadges absolute bottom-1 z-40 text-primary text-xs">
