...
const Blog = ({ posts }) => {
  ...
  return (
    <section className=" mx-auto grid grid-cols-1 min-h-screen mt-28 w-full">
      ...
      <div className="flex justify-center items-center bg-white rounded-md mx-[900px] px-0 font-semibold text-xl  text-secondary h-10 hover:bg-secondary hover:text-white">
        <a href="#">All Posts</a>
      </div>
    </section>
  );
